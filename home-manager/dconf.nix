...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/app-folders/folders/502da463-a171-48bf-a485-b27e6ef744e1" = {
      apps = [ "firefox.desktop" "thunderbird.desktop" "info.mumble.Mumble.desktop" "hakuneko-desktop.desktop" ];
      name = "Internet";
    };
    ...
    "org/gnome/pomodoro/state" = {
      timer-date = "2023-06-16T12:14:22+0000";
      timer-elapsed = 0.0;
      timer-paused = false;
      timer-score = 0.0;
      timer-state = "null";
      timer-state-date = "2023-06-16T12:14:22+0000";
    ...
    "org/gnome/settings-daemon/plugins/media-keys" = {
      custom-keybindings = [ "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom0/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom3/" "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom4/" ];
      email = [ "<Super>m" ];
      home = [ "<Super>f" ];
      logout = [ "<Super>x" ];
      magnifier-zoom-in = [];
    ...
    "org/gnome/shell" = {
      app-picker-layout = "[{'Utilities': <{'position': <0>}>, 'aac2832b-c83a-490c-97f7-9071a4548ce3': <{'position': <1>}>, 'bf60595e-f9f5-4bee-aa76-18c109f1caaa': <{'position': <2>}>, '502da463-a171-48bf-a485-b27e6ef744e1': <{'position': <3>}>, '421bec7f-e535-4e61-bd60-3f1f22d6ab51': <{'position': <4>}>}]";
    ...
    "org/gnome/terminal/legacy/profiles:" = {
      ...
      list = [ "5d738f04-f702-46a2-9575-03876f8ab496" "0f05d245-3b64-4555-b9f2-4f5aa43cd4e7" "10b5cdcc-d126-4d69-85da-21023f400f3a" "45dcbd72-c045-49a5-b4c7-7238369607c9" ];
    };
    ...
    "org/gnome/terminal/legacy/profiles:/:45dcbd72-c045-49a5-b4c7-7238369607c9" = {
      ...
      palette = [ "#929292929292" "#E2E273737373" "#9494B9B97979" "#FFFFBABA7B7B" "#9797BEBEDCDC" "#E1E1C0C0FAFA" "#000098988E8E" "#DEDEDEDEDEDE" "#BDBDBDBDBDBD" "#FFFFA1A1A1A1" "#BDBDDEDEABAB" "#FFFFDCDCA0A0" "#B1B1D8D8F6F6" "#FBFBDADAFFFF" "#1A1AB2B2A8A8" "#FFFFFFFFFFFF" ];
      use-theme-background = false;
      use-theme-colors = false;
      use-theme-transparency = false;
