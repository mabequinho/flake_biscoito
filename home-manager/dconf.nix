...

{
  dconf.settings = {
    ...
    "org/gnome/shell" = {
      app-picker-layout =
        "[{'502da463-a171-48bf-a485-b27e6ef744e1': <{'position': <0>}>, 'bf60595e-f9f5-4bee-aa76-18c109f1caaa': <{'position': <1>}>, '421bec7f-e535-4e61-bd60-3f1f22d6ab51': <{'position': <2>}>, 'aac2832b-c83a-490c-97f7-9071a4548ce3': <{'position': <3>}>, 'Utilities': <{'position': <4>}>}]";
